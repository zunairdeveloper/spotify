...
;(function () {
  ...
  let SONGS = [
    ...
    { id: 'bts-8',    title: 'Life Goes On',                 artist: 'BTS', artistId: 'bts', album: 'BE',                         duration: '3:27', src: null, cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/02/c5/18/02c518f5-ac06-3321-622e-08d9429fd968/192562556672_Cover.jpg/600x600bb.jpg', category: 'kpop', isTrending: false },
    { id: 'bts-9',    title: 'ON',                           artist: 'BTS', artistId: 'bts', album: 'MAP OF THE SOUL: 7',         duration: '4:06', src: null, cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/40/d4/93/40d493e3-ac9e-1746-8d4c-f380f27c97cb/193483706238_Cover.jpg/600x600bb.jpg', category: 'kpop', isTrending: false },
    { id: 'bts-10',   title: 'Black Swan',                   artist: 'BTS', artistId: 'bts', album: 'MAP OF THE SOUL: 7',         duration: '3:40', src: null, cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/40/d4/93/40d493e3-ac9e-1746-8d4c-f380f27c97cb/193483706238_Cover.jpg/600x600bb.jpg', category: 'kpop', isTrending: false },
    { id: 'bts-11',   title: 'Idol',                         artist: 'BTS', artistId: 'bts', album: 'Love Yourself: Answer',      duration: '3:43', src: null, cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/02/c5/18/02c518f5-ac06-3321-622e-08d9429fd968/192562556672_Cover.jpg/600x600bb.jpg', category: 'kpop', isTrending: false },
    { id: 'bts-12',   title: 'Not Today',                   artist: 'BTS', artistId: 'bts', album: 'You Never Walk Alone',       duration: '3:52', src: null, cover: 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/02/c5/18/02c518f5-ac06-3321-622e-08d9429fd968/192562556672_Cover.jpg/600x600bb.jpg', category: 'kpop', isTrending: false },
    ...
    { id: 'atif-6',   title: 'Doorie',                       artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Doorie',                     duration: '4:15', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-7',   title: 'Aadat',                        artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Jal Pari',                   duration: '4:30', src: null, cover: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80', category: 'bollywood', isTrending: true  },
    { id: 'atif-8',   title: 'Dil Diyan Gallan',             artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Tiger Zinda Hai',            duration: '4:26', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-9',   title: 'Jeena Jeena',                  artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Badlapur',                   duration: '4:14', src: null, cover: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-10',  title: 'Bakhuda Tumhi Ho',             artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Kismat Konnection',          duration: '4:52', src: null, cover: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-11',  title: 'Main Rang Sharbaton Ka',       artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Phata Poster Nikhla Hero',   duration: '4:40', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-12',  title: 'Jab Tak',                     artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'M.S. Dhoni: The Untold Story',duration: '4:08', src: null, cover: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'atif-13',  title: 'Kun Faya Kun',                 artist: 'Atif Aslam', artistId: 'atif-aslam', album: 'Rockstar',                   duration: '7:52', src: null, cover: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80', category: 'bollywood', isTrending: false },

    // ── Arijit Singh (13 songs) ─────────────────────────────────────────────────
    ...
    { id: 'arj-6',    title: 'Agar Tum Saath Ho',            artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Tamasha',                    duration: '5:42', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-7',    title: 'Arijit Medley',                artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Live',                       duration: '5:00', src: null, cover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-8',    title: 'Phir Le Aaya Dil',             artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Barfi!',                     duration: '3:51', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-9',    title: 'Soch Na Sake',                 artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Airlift',                    duration: '4:38', src: null, cover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-10',   title: 'Kabira',                       artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Yeh Jawaani Hai Deewani',    duration: '3:42', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-11',   title: 'Hawayein',                     artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Jab Harry Met Sejal',        duration: '4:42', src: null, cover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-12',   title: 'Ae Dil Hai Mushkil',           artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Ae Dil Hai Mushkil',         duration: '4:28', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'arj-13',   title: 'Mere Naam Tu',                 artist: 'Arijit Singh', artistId: 'arijit-singh', album: 'Zero',                       duration: '4:54', src: null, cover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=600&q=80', category: 'bollywood', isTrending: false },

    // ── Diljit Dosanjh (12 songs) ───────────────────────────────────────────────
    ...
    { id: 'diljit-5',  title: 'Kinni Kinni',                 artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'MoonChild Era',              duration: '3:15', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-6',  title: 'Lehnga',                      artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'G.O.A.T.',                   duration: '3:10', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: true  },
    { id: 'diljit-7',  title: 'Goat',                        artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'G.O.A.T.',                   duration: '3:22', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-8',  title: 'Patiala Peg',                 artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'Patiala Peg',                duration: '3:30', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-9',  title: 'Do You Know',                 artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'Panjabi Side',               duration: '3:45', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-10', title: 'Raat Di Gedi',                artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'Raat Di Gedi',               duration: '3:58', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-11', title: 'High End',                    artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'Dil',                        duration: '3:28', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'diljit-12', title: 'Kylie + Kareena',             artist: 'Diljit Dosanjh', artistId: 'diljit-dosanjh', album: 'MoonChild Era',              duration: '3:05', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    ...
    { id: 'ap-5',     title: 'Summer High',                  artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'Summer High - Single',       duration: '2:58', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'ap-6',     title: 'Chamkeela Chehra',             artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'Hidden Gems 2',              duration: '2:48', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'ap-7',     title: 'Insane',                       artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'Insane - Single',            duration: '2:25', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'ap-8',     title: 'Not Rich Yet',                 artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'Run-Up Records',             duration: '3:12', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'ap-9',     title: 'One Step Away',                artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'One Step Away - Single',     duration: '3:01', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'ap-10',    title: 'Tenu',                         artist: 'AP Dhillon', artistId: 'ap-dhillon', album: 'Tenu - Single',              duration: '2:40', src: null, cover: 'https://images.unsplash.com/photo-1520523839898-507125cd53c1?w=600&q=80', category: 'punjabi', isTrending: false },
    ...
    { id: 'wknd-5',   title: 'Call Out My Name',             artist: 'The Weeknd', artistId: 'the-weeknd', album: 'My Dear Melancholy',         duration: '3:49', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-6',   title: 'In Your Eyes',                 artist: 'The Weeknd', artistId: 'the-weeknd', album: 'After Hours',                duration: '3:57', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-7',   title: 'Can\'t Feel My Face',          artist: 'The Weeknd', artistId: 'the-weeknd', album: 'Beauty Behind the Madness',  duration: '3:35', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-8',   title: 'I Feel It Coming',             artist: 'The Weeknd', artistId: 'the-weeknd', album: 'Starboy',                    duration: '4:29', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-9',   title: 'Earned It',                    artist: 'The Weeknd', artistId: 'the-weeknd', album: 'Fifty Shades of Grey',       duration: '4:07', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-10',  title: 'Moth To A Flame',              artist: 'Swedish House Mafia & The Weeknd', artistId: 'the-weeknd', album: 'Paradise Again',  duration: '3:34', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-11',  title: 'Take My Breath',               artist: 'The Weeknd', artistId: 'the-weeknd', album: 'Dawn FM',                    duration: '5:38', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },
    { id: 'wknd-12',  title: 'Sacrifice',                    artist: 'The Weeknd', artistId: 'the-weeknd', album: 'Dawn FM',                    duration: '3:08', src: null, cover: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=600&q=80', category: 'international', isTrending: false },

    // ── Taylor Swift (13 songs) ─────────────────────────────────────────────────
    ...
    { id: 'ts-5',     title: 'Blank Space',                  artist: 'Taylor Swift', artistId: 'taylor-swift', album: '1989',                       duration: '3:51', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-6',     title: 'Bad Blood (feat. Kendrick Lamar)', artist: 'Taylor Swift', artistId: 'taylor-swift', album: '1989',                   duration: '3:32', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-7',     title: 'Wildest Dreams',               artist: 'Taylor Swift', artistId: 'taylor-swift', album: '1989',                       duration: '3:40', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-8',     title: 'Style',                        artist: 'Taylor Swift', artistId: 'taylor-swift', album: '1989',                       duration: '3:51', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-9',     title: 'Lavender Haze',                artist: 'Taylor Swift', artistId: 'taylor-swift', album: 'Midnights',                  duration: '3:22', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-10',    title: 'Bejeweled',                    artist: 'Taylor Swift', artistId: 'taylor-swift', album: 'Midnights',                  duration: '3:15', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-11',    title: 'You Belong With Me',           artist: 'Taylor Swift', artistId: 'taylor-swift', album: 'Fearless',                   duration: '3:51', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-12',    title: 'cardigan',                     artist: 'Taylor Swift', artistId: 'taylor-swift', album: 'Folklore',                   duration: '3:59', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },
    { id: 'ts-13',    title: 'All Too Well (10 Min Version)', artist: 'Taylor Swift', artistId: 'taylor-swift', album: 'Red (Taylor\'s Version)',    duration: '10:13', src: null, cover: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80', category: 'international', isTrending: false },

    // ── Shreya Ghoshal (10 songs) ───────────────────────────────────────────────
    { id: 'sg-1',     title: 'Tujh Mein Rab Dikhta Hai',    artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Rab Ne Bana Di Jodi',        duration: '5:20', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: true  },
    { id: 'sg-2',     title: 'Teri Meri',                   artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Bodyguard',                  duration: '4:37', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: true  },
    { id: 'sg-3',     title: 'Saans',                       artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Jab Tak Hai Jaan',           duration: '6:02', src: null, cover: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-4',     title: 'Sunn Raha Hai',               artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Aashiqui 2',                 duration: '4:45', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-5',     title: 'Dheere Dheere Se',            artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Aashiqui',                   duration: '4:21', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-6',     title: 'Lag Ja Gale',                 artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Woh Kaun Thi',               duration: '3:32', src: null, cover: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-7',     title: 'Piyu Bole',                   artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Parineeta',                  duration: '5:00', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-8',     title: 'Yeh Ishq Haaye',              artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Jab We Met',                 duration: '5:05', src: null, cover: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-9',     title: 'Barso Re',                    artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Guru',                       duration: '4:48', src: null, cover: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?w=600&q=80', category: 'bollywood', isTrending: false },
    { id: 'sg-10',    title: 'Ghoomar',                     artist: 'Shreya Ghoshal', artistId: 'shreya-ghoshal', album: 'Padmaavat',                  duration: '5:29', src: null, cover: 'https://images.unsplash.com/photo-1487180144351-b8472da7d491?w=600&q=80', category: 'bollywood', isTrending: false },

    // ── Sidhu Moosewala (10 songs) ──────────────────────────────────────────────
    { id: 'sm-1',     title: 'So High',                     artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'PBX 1',                     duration: '3:18', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: true  },
    { id: 'sm-2',     title: 'Legend',                      artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'The Last Ride',              duration: '3:54', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: true  },
    { id: 'sm-3',     title: '295',                         artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'The Last Ride',              duration: '5:10', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: true  },
    { id: 'sm-4',     title: 'Moosetape (Full Album)',       artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'Moosetape',                 duration: '4:00', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-5',     title: 'G Wagon',                     artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'Moosetape',                 duration: '2:58', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-6',     title: 'Badfella',                    artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'Moosetape',                 duration: '3:25', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-7',     title: 'SYL',                         artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'SYL - Single',               duration: '3:42', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-8',     title: 'Old Skool',                   artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'Moosetape',                 duration: '3:55', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-9',     title: 'The Last Ride',               artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'The Last Ride',              duration: '4:15', src: null, cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80', category: 'punjabi', isTrending: false },
    { id: 'sm-10',    title: 'Jatti Jeone Morh Wargi',      artist: 'Sidhu Moosewala', artistId: 'sidhu-moosewala', album: 'Moosetape',                 duration: '3:30', src: null, cover: 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?w=600&q=80', category: 'punjabi', isTrending: false },
  ...
  async function fetchArtistSongs(artist) {
    ...
    // Songs already in the SONGS array for this artist
    const knownFullSongs = SONGS.filter(s => s.artistId === artist.id);

    try {
      // Use multi-country search to get maximum results (50 per country)
      const [inData, usData, pkData] = await Promise.all([
        itunesSearchSingle(artist.searchTerm || artist.name, 'in', 50),
        itunesSearchSingle(artist.searchTerm || artist.name, 'us', 50),
        itunesSearchSingle(artist.searchTerm || artist.name, 'pk', 30)
      ]);
      ...
      if (allRaw.length > 0) {
        ...
        allRaw.forEach((r, idx) => {
          if (!r || !r.previewUrl) return;
          const titleKey = (r.trackName || '').toLowerCase().trim();
        ...
        // Known full-audio songs go first, then fill with iTunes previews
        const combined = [...knownFullSongs];
        playableTracks.forEach(pt => {
          const ptKey = pt.title.toLowerCase().split('(')[0].trim();
          const alreadyIn = combined.some(k => {
            const kKey = k.title.toLowerCase().split('(')[0].trim();
            return kKey === ptKey || kKey.includes(ptKey) || ptKey.includes(kKey);
          });
          if (!alreadyIn) {
            combined.push(pt);
    ...
    // Fallback: return whatever we already have
